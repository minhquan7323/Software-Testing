    ...
    if (isset($_GET["adminlayout"])) {
        switch ($_GET["adminlayout"]) {
            ...
            case 'suadanhmuc':
                ...
                break;
            case 'xoadanhmuc':
                include_once('./adminxoadanhmuc.php');
                break;
            case 'suasp':
                    ...
                    <div class="sidebar">
                        ...
                        <div class="menu">
                            <a href="./admin.php?adminlayout=admintrangchu">
                                <li class="menu_item <?php if (isset($_GET["adminlayout"]) && $_GET["adminlayout"] == "admintrangchu") {
                                                            echo "active";
                                                        } else if ($tmplayoutadmin == 'admintrangchu') {
                                                            echo "active";
                                                        } ?> "><i class="fas fa-house"></i>Trang chủ</li>
                            </a>
                            <a href="./admin.php?adminlayout=adminnguoidung">
                                <li class="menu_item <?php if (isset($_GET["adminlayout"]) && $_GET["adminlayout"] == "adminnguoidung") {
                                                            echo "active";
                                                        } ?> "><i class="fas fa-tag"></i>Quản lý người dùng</li>
                            </a>
                            <a href="./admin.php?adminlayout=adminsanpham">
                                <li class="menu_item <?php if (isset($_GET["adminlayout"]) && $_GET["adminlayout"] == "adminsanpham") {
                                                            echo "active";
                                                        } ?>"><i class="fas fa-bag-shopping"></i>Quản lý sản phẩm</li>
                            </a>
                            <a href="./admin.php?adminlayout=admindanhmuc">
                                <li class="menu_item <?php if (isset($_GET["adminlayout"]) && $_GET["adminlayout"] == "admindanhmuc") {
                                                            echo "active";
                                                        } ?>"><i class="fas fa-bag-shopping"></i>Quản lý danh muc</li>
                            </a>
                            <a href="./admin.php?adminlayout=quanlydonhang">
                                <li class="menu_item <?php if (isset($_GET["adminlayout"]) && $_GET["adminlayout"] == "quanlydonhang") {
                                                            echo "active";
                                                        } ?>"><i class="fas fa-address-card"></i>Quản lý hóa đơn</li>
                            </a>
                        </div>
